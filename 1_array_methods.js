...
const johnDoeFriends = data.filter(person => person.friends.some(friend => friend.name === "John Doe"));
console.log(`John Doe have : ${johnDoeFriends.length} friends`);
johnDoeFriends.forEach(person => {
  console.log(`friend : ${person.name} is ${ person.age}`);
})
